...
class _$ErrorResponseModelImpl implements _ErrorResponseModel {
  _$ErrorResponseModelImpl({this.status, this.message});
  ...
  @override
  String toString() {
    return 'ErrorResponseModel(status: $status, message: $message)';
  }
...
abstract class _ErrorResponseModel implements ErrorResponseModel {
  factory _ErrorResponseModel({final bool? status, final String? message}) =
